...
export default {
    ...
    data() {
        return {
            showPay:false,           //是否显示 微信支付二维码
            showDetail:false,       //是否显示 支付的商品详情
            orderId:this.$route.query.orderNo,      //支付的单号
            addressInfo:'',      //收货人地址
            orderDetail:[],       //商品订单详情 包含商品订单列表
            payType:'',  //支付类型 
            payment:0,          //要支付的总价格
            payImg:"",        //微信支付二维码地址
    ...
    methods:{
            ...
            paysubmit(payType){
                if(payType == 1){
                    window.open('/#/order/alipay?orderId='+this.orderId,'_blan');
                }else{
                    // 微信支付
                    this.axios.post('/pay',{
